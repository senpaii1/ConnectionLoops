...
const stripeKey =
	'pk_test_51K2CADSJh0flLVTFDlufuo9bTxTbbLDuq7nxblDnQSmnSlNvVzxYPyoC2GDdbXNGjaHyKikLQvzUcV01u4GvwyYz00BCRibshD';
...
export default function PaymentPage(props) {
	...
	function handleToken(token, addresses) {
		...
		axios.post('/inventory/checkout', newOrder).then(res => {
